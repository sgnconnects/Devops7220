...
function decode(encoded_data) {
    ...
    // decode from base 64
    var buffer = base64ToArray(encoded_data);
    // Decode using protobuff
    var data = PricingData.decode(buffer);
    console.log(data);
...
app.post('/decode',function(req,res){
    let encoded_data = req.body.encodedData;
    console.log(encoded_data);
    try{
        return res.json(decode(encoded_data));
    }catch (e) {
        console.log(e);
        return res.json({"error": "Error from Finance Quote Streamer"});
    }
});
